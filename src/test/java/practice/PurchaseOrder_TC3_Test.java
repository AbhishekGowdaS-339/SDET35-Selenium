...
public class PurchaseOrder_TC3_Test {
public static void main(String[] args) throws Throwable {
		...
		String purchaseSub =exl.getStringDataFromExcel("Sheet1", 4, 10)+jav.getRandomNum();
		String billingAdd =exl.getStringDataFromExcel("Sheet1", 4, 11);
		String shippingAdd =exl.getStringDataFromExcel("Sheet1", 4, 12);
		int qty =(int)exl.getNumDataFromExcel("Sheet1", 4, 13);
