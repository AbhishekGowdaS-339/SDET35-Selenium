...
public static void main(String[] args) throws Throwable {
		...
		while(it1.hasNext()) {
			...
			if(title.contains(actualProductMsg)) 
				break;
		}
		...
		//driver.findElement(By.name("Delete")); // this statement is used to delete the created organization but the statement is incomplete
