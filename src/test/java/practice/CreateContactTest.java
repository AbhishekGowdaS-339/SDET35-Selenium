...
public class CreateContactTest {
	public static void main(String[] args) throws Throwable {
		...
		String LastName =workbook.getSheet("Sheet1").getRow(4).getCell(7).getStringCellValue()+ranumber;
		...
		if(actualSucceessfulMsg.contains(LastName)) 
			System.out.println("Contact is successfully created and information is displayed :: Pass");
		else
